...
void lvgl_task(void *arg)
{
    ...
    disp_drv.sw_rotate = 1;          /**< 1: use software rotation (slower)*/
    disp_drv.rotated = LV_DISP_ROT_90; /**< 1: turn the display by 90 degree. @warning Does not update coordinates for you!*/
