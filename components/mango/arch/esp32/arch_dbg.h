...
/* log config */
#define  ETSS_LOG_ANSI_COLOR_ENABLE  1

#ifndef ET_LOG_LEVEL
#define ET_LOG_LEVEL                LOG_LEVEL_INFO
#define g_log_level                 LOG_LEVEL_INFO
#endif
/* log config */

#if ETSS_LOG_ANSI_COLOR_ENABLE
...
#define LOG_LEVEL                               ET_LOG_LEVEL

#if ET_LOG_LEVEL <= LOG_LEVEL_VERBOSE

#define LOG_DEBUG(_fmt_, ...)                        \
    do{                                              \
        if(g_log_level <= LOG_LEVEL_VERBOSE){        \
            arch_printf_begin(LOG_ANSI_COLOR_OFF);   \
...
#if ET_LOG_LEVEL <= LOG_LEVEL_INFO
...
#if ET_LOG_LEVEL <= LOG_LEVEL_WARNING
...
#if ET_LOG_LEVEL <= LOG_LEVEL_ERROR
...
#if ET_LOG_LEVEL <= LOG_LEVEL_FATAL
